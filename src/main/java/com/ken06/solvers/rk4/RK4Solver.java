...
public class RK4Solver extends ODESolver {
    ...
    public RK4Solver(ODEFunction green,PhysicsEngine engine){
        this.green = green;
        double sandFriction = 1.0;
        this.user = null;
        this.engine = engine;
    }
    public RK4Solver(ODEFunction green,PhysicsEngine engine,String user){
        this.green = green;
        double sandFriction = 1.0;
        this.user = user;
        this.engine = engine;
